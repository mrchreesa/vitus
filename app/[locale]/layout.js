...
export async function generateMetadata({ params: { locale = "en" } }) {
	return {
		...
		description: locale === "bg" ? "Предоставяме индивидуално и семейно консултиране, организационно обучение и супервизия за професионалисти от помагащите професии" : "Providing individual and family counselling, organisational training and supervision for professionals from the helping professions",
		twitter: {
...
export default function LocaleLayout({ children, params: { locale } }) {
	...
	return (
		<html lang={locale} className={`${mont.variable} font-sans ${typo.variable} font-sans`}>
			<head>
				<meta charSet="UTF-8" />
				{shouldPreloadImage && <link rel="preload" href="/maze.jpeg" as="image" />}
				<link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png" />
				<meta property="og:image" content="https://centrevitus.com/opengraph-image.png" />
